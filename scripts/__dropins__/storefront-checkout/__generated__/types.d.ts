...
export type BundleOrderItem = OrderItemInterface & {
    ...
    eligible_for_return: Scalars['Boolean']['output'];
    ...
    /** The number of refunded items. */
    quantity_refunded?: Maybe<Scalars['Float']['output']>;
    /** The quantity of item requested for return. */
...
export type CartItemPrices = {
    ...
    /** The value of the original unit price for the item, with no discounts or taxes applied. */
    original_item_price: Money;
    /** The value of the original price multiplied by the quantity of the item, with no discounts or taxes applied. */
...
export declare enum CompaniesSortFieldEnum {
...
export type Company = {
    ...
    available_shipping_methods?: Maybe<Array<Maybe<CompanyAvailableShippingMethod>>>;
...
export type CompanyAvailableShippingMethod = {
    __typename?: 'CompanyAvailableShippingMethod';
    code: Scalars['String']['output'];
    title: Scalars['String']['output'];
};
...
export type CompanyCredit = {
    ...
    exceed_limit: Scalars['Boolean']['output'];
...
export declare enum CompanyCreditOperationUserType {
    Admin = "ADMIN",
    Customer = "CUSTOMER"
}
...
export declare enum CompanyUserStatusEnum {
    /** Only active users. */
    Active = "ACTIVE",
    /** Only inactive users. */
    Inactive = "INACTIVE"
...
export type Customer = {
    ...
    gift_registry?: Maybe<GiftRegistry>;
    /** Uid of the customer group assigned to the customer */
    ...
    segments?: Maybe<Array<Maybe<CustomerSegmentStorefront>>>;
    /** Indicates whether the company user is ACTIVE or INACTIVE. */
...
/** Customer segment. */
export type CustomerSegmentStorefront = {
    __typename?: 'CustomerSegmentStorefront';
...
export declare enum DeletePurchaseOrderApprovalRuleErrorType {
    NotFound = "NOT_FOUND",
    Undefined = "UNDEFINED"
}
...
export type ExchangeExternalCustomerTokenInput = {
...
export type ExchangeExternalCustomerTokenOutput = {
    __typename?: 'ExchangeExternalCustomerTokenOutput';
...
export type Mutation = {
    ...
    exchangeExternalCustomerToken?: Maybe<ExchangeExternalCustomerTokenOutput>;
    /** Generate a token for specified customer. */
...
export type MutationExchangeExternalCustomerTokenArgs = {
    input?: InputMaybe<ExchangeExternalCustomerTokenInput>;
};
...
export declare enum NegotiableQuoteCommentCreatorType {
    Buyer = "BUYER",
    Seller = "SELLER"
}
...
export declare enum NegotiableQuoteTemplateSortableField {
...
export type PlaceNegotiableQuoteOrderOutput = {
    ...
    /** Contains the generated order number. Null when errors occur. */
    order?: Maybe<Order>;
...
export declare enum PurchaseOrderAction {
    Approve = "APPROVE",
    Cancel = "CANCEL",
...
export declare enum PurchaseOrderApprovalFlowItemStatus {
    Approved = "APPROVED",
    Pending = "PENDING",
    Rejected = "REJECTED"
}
...
export type Query = {
    ...
    /** Provides uid of the Customer Group assigned to the Customer or Guest. */
    ...
    customerSegments?: Maybe<Array<Maybe<CustomerSegmentStorefront>>>;
...
export type StoreConfig = {
    ...
    /** Indicates if company registration is allowed */
    allow_company_registration: Scalars['Boolean']['output'];
     ...
     */
    code?: Maybe<Scalars['String']['output']>;
    /** Indicates if B2B company functionality is enabled */
    company_enabled: Scalars['Boolean']['output'];
    ...
    graphql_share_customer_group: Scalars['Boolean']['output'];
    ...
    share_active_segments: Scalars['Boolean']['output'];
    /** Configuration data from promo/graphql/share_applied_cart_rule */
    share_applied_cart_rule: Scalars['Boolean']['output'];
...
export type GetCustomerCartQueryVariables = Exact<{
    [key: string]: never;
}>;
...
export type Get_Checkout_AgreementsQueryVariables = Exact<{
    [key: string]: never;
}>;
export type Get_Checkout_AgreementsQuery = {
    __typename?: 'Query';
    checkoutAgreements?: Array<{
        __typename?: 'CheckoutAgreement';
        agreement_id: number;
...
export type GetCompanyCreditQueryVariables = Exact<{
    [key: string]: never;
}>;
export type GetCompanyCreditQuery = {
    __typename?: 'Query';
    company?: {
        __typename?: 'Company';
        credit: {
...
export type GetNegotiableQuoteQueryVariables = Exact<{
    quoteId: Scalars['ID']['input'];
}>;
export type GetNegotiableQuoteQuery = {
    __typename?: 'Query';
    negotiableQuote?: {
        __typename?: 'NegotiableQuote';
        email?: string | null;
        ...
        billing_address?: {
            ...
            city: string;
            company?: string | null;
            customer_address_uid?: string | null;
            fax?: string | null;
            firstname: string;
            lastname: string;
            middlename?: string | null;
...
export type Billing_Cart_Address_FragmentFragment = {
    __typename?: 'BillingCartAddress';
    city: string;
    company?: string | null;
    fax?: string | null;
...
export type Shipping_Cart_Address_FragmentFragment = {
    __typename?: 'ShippingCartAddress';
    city: string;
    company?: string | null;
    fax?: string | null;
...
export type Checkout_Data_FragmentFragment = {
    __typename?: 'Cart';
    id: string;
    is_virtual: boolean;
    email?: string | null;
...
export type Customer_FragmentFragment = {
    __typename?: 'Customer';
    firstname?: string | null;
    lastname?: string | null;
    email?: string | null;
};
export type Negotiable_Quote_Billing_Address_FragmentFragment = {
    __typename?: 'NegotiableQuoteBillingAddress';
    city: string;
    company?: string | null;
    customer_address_uid?: string | null;
...
export type Negotiable_Quote_Shipping_Address_FragmentFragment = {
    __typename?: 'NegotiableQuoteShippingAddress';
    city: string;
    company?: string | null;
    customer_address_uid?: string | null;
...
export type Negotiable_Quote_FragmentFragment = {
    __typename?: 'NegotiableQuote';
    email?: string | null;
    is_virtual: boolean;
    name: string;
...
export type Available_Payment_Method_FragmentFragment = {
    __typename?: 'AvailablePaymentMethod';
    code: string;
    title: string;
};
export type Selected_Payment_Method_FragmentFragment = {
    __typename?: 'SelectedPaymentMethod';
    code: string;
    title: string;
    purchase_order_number?: string | null;
};
export type Available_Shipping_Method_FragmentFragment = {
    __typename?: 'AvailableShippingMethod';
    carrier_code: string;
    carrier_title: string;
    error_message?: string | null;
...
export type Selected_Shipping_Method_FragmentFragment = {
    __typename?: 'SelectedShippingMethod';
    carrier_code: string;
    carrier_title: string;
    method_code: string;
...
export type SetBillingAddressOnQuoteMutationVariables = Exact<{
    quoteId: Scalars['ID']['input'];
    billingAddress: NegotiableQuoteBillingAddressInput;
}>;
export type SetBillingAddressOnQuoteMutation = {
    __typename?: 'Mutation';
...
export type SetPaymentMethodOnQuoteMutationVariables = Exact<{
    quoteId: Scalars['ID']['input'];
    input: NegotiableQuotePaymentMethodInput;
}>;
export type SetPaymentMethodOnQuoteMutation = {
    __typename?: 'Mutation';
...
export type SetShippingAddressOnCartAndUseAsBillingMutationVariables = Exact<{
    cartId: Scalars['String']['input'];
    shippingAddress: ShippingAddressInput;
}>;
export type SetShippingAddressOnCartAndUseAsBillingMutation = {
    __typename?: 'Mutation';
...
export type SetShippingAddressOnQuoteMutationVariables = Exact<{
    quoteId: Scalars['ID']['input'];
    shippingAddress: NegotiableQuoteShippingAddressInput;
}>;
export type SetShippingAddressOnQuoteMutation = {
    __typename?: 'Mutation';
...
export type SetShippingAddressOnQuoteAndUseAsBillingMutationVariables = Exact<{
    quoteId: Scalars['ID']['input'];
    shippingAddress: NegotiableQuoteShippingAddressInput;
}>;
export type SetShippingAddressOnQuoteAndUseAsBillingMutation = {
    __typename?: 'Mutation';
    setNegotiableQuoteShippingAddress?: {
        __typename?: 'SetNegotiableQuoteShippingAddressOutput';
        quote?: {
...
export type SetShippingMethodsOnQuoteMutationVariables = Exact<{
    quoteId: Scalars['ID']['input'];
    shippingMethods: Array<InputMaybe<ShippingMethodInput>> | InputMaybe<ShippingMethodInput>;
}>;
export type SetShippingMethodsOnQuoteMutation = {
    __typename?: 'Mutation';
